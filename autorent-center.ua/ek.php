...
<ul class="hr20">
  ...
  <li>
  <li>
     <a onClick="showContent('biz.php')">Бізнес кслас</a>
  </li>
  <li>
    <a onClick="showContent('ek.php')">Економ кслас</a>
  </li>
  <li>
...
$stmt = $pdo->query("SELECT * FROM  `price` LEFT JOIN car ON price.price_id = car.id_car WHERE klass = 'Эконом'  LIMIT 8 ");
$stmt->execute();
