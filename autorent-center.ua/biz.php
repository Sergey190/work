...
<div id="conntent">
  ...
  <div class="content">
    <h1 class="title">Аренда новых автомобилей с доставкой по адресу за час</h1>
    <<a onClick="showContent('bron.php')" class="button24">Взять на прокат авто</a>
  </div>
...
<ul class="hr20">
  ...
  <li>
  <li>
     <a onClick="showContent('biz.php')">Бізнес класс</a>
  </li>
  <li>
...
$stmt = $pdo->query("SELECT * FROM  `price` LEFT JOIN car ON price.price_id = car.id_car WHERE klass = 'Бизнес'  LIMIT 8 ");
$stmt->execute();
