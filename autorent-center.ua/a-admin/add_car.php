...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-6">
            <h1 class="page-header">Автопарк</h1>
        </div>
        <div class="col-lg-6">
            <div class="page-action-links text-right">
                <a href="addd_car.php?operation=create" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Додати нове</a>
            </div>
        </div>
    </div>
...
echo '
 ...
 <td>' . 
         ...
         <a href="viev_car.php?  id=' . $row['id_car'] . '" class="btn btn-info"> <i class="fa fa-eye" aria-hidden="true"></i> </a>
         <a href="up_cars.php?  id=' . $row['id_car'] . '" class="btn btn-primary"> <i class="glyphicon glyphicon-edit"></i></a>
