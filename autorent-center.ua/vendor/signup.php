...
$sql = "INSERT INTO `kilent` (`id`, `fio`, `adress`, `phone`, `emaill`, `birsday`,`inn`,`shtrafts`,`login`,`pass`) VALUES (NULL, '$fio', '$adres', '$phone', '$emaill', '$month','$inn','-','$login','$pass');";
...
<div class="oke">
    ...
    <h3>Ви успішно зарестровані!</h3><br>
